                ...
                <div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
                  ...
                  "
                    >
                      ...
                      organization needs instead of selling you a mass market
                      tool that takes a one size fits all approach. I personally
                      review each and every client business and oversee the team
                      ...
                      <div>
                        <div className="flex items-center pl-3 text-green-400">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="
                          icon icon-tabler icon-tabler-trending-up
                          text-green-700
                        "
                            width="24"
                            height="24"
